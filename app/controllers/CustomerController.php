...
class CustomerController extends BaseController {
    ...
    public function getIndex()
    {
        ...
        // Show the page
        return View::make('site/customer/index', compact('user'));
    }
        ...
        if ($validator->passes())
        {
            ...
            if(!empty($password)) {
                if($password === $passwordConfirmation) {
                    ...
                    // Redirect to the new user page
                    return Redirect::to('customer')->with('error', Lang::get('admin/customers/messages.password_does_not_match'));
                }
            } else {
                unset($user->password);
    ...
    {
        return View::make('site/customer/create');
    }
    ...
    public function getLogin()
    {
        ...
        return View::make('site/customer/login');
    }
